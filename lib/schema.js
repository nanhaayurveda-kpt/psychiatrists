...
export const clinics = sqliteTable("clinics", {
  ...
  pin_psychologist: text("pin_psychologist").default(""),
  email_receptionist: text("email_receptionist").default(""),
  email_pharmacy: text("email_pharmacy").default(""),
  email_psychologist: text("email_psychologist").default(""),
...
export const prescriptions = sqliteTable("prescriptions", {
  ...
  bp: text("bp").default(""),
  detailed_history: text("detailed_history").default(""),
